...
def vit_relevance(image, target_features, img_encoder, device, method="last grad", neg_saliency=False, custom_objective=None, all_text_features=None):
    ...
    if custom_objective:
        ...
        print(weighted_text_feature.shape)
        image_features_text = image_features_new + weighted_text_feature
        print(image_features_text.shape)
